...
class MarketOrderIndicator : public atrade::async2::Indicator<atrade::DealType>
{
public:
    MarketOrderIndicator(boost::asio::io_service& ios, int64_t isin_id, int volume, const atrade::pt::time_duration& duration, double mul) :
    ...
    MarketOrderIndicator(boost::asio::io_service& ios, int64_t isin_id, int volume, const atrade::pt::time_duration& duration) :
        MarketOrderIndicator(ios, isin_id, volume, duration, 2)
    {
    }

    MarketOrderIndicator(boost::asio::io_service& ios, int64_t isin_id, const atrade::pt::time_duration& duration, double mul) :
        MarketOrderIndicator(ios, isin_id, 0, duration, mul)
    {
    }
