...
//class ScalperStrategy6 : public atrade::async2::IStrategy
//{
//public:
//    typedef std::shared_ptr<atrade::async2::BooleanIndicator> IndicatorPtr;

//    ScalperStrategy6(boost::asio::io_service* ios, atrade::async2::TradingContext* ctx, int64_t isin_id) :
//        m_ios(ios),
//        m_ctx(ctx),
//        m_isin_id(isin_id),
//        m_profit_trades(0),
...
//    ScalperStrategy6(boost::asio::io_service& ios, atrade::async2::TradingContext& ctx, int64_t isin_id) :
//        ScalperStrategy6(&ios, &ctx, isin_id)
//    {
//    }

//    ScalperStrategy6(int64_t isin_id) :
//        ScalperStrategy6(nullptr, nullptr, isin_id)
//    {
//    }
