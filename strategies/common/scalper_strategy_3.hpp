...
//class ScalperStrategy3
//{
//public:
//    typedef std::shared_ptr<atrade::async2::BooleanIndicator> IndicatorPtr;

//    ScalperStrategy3(boost::asio::io_service* ios, atrade::async2::TradingContext* ctx, int64_t isin_id) :
//        m_ios(ios),
//        m_ctx(ctx),
//        m_isin_id(isin_id),
//        m_profit_trades(0),
...
//    ScalperStrategy3(boost::asio::io_service& ios, atrade::async2::TradingContext& ctx, int64_t isin_id) :
//        ScalperStrategy3(&ios, &ctx, isin_id)
//    {
//    }

//    ScalperStrategy3(int64_t isin_id) :
//        ScalperStrategy3(nullptr, nullptr, isin_id)
//    {
//    }
...
//            for (int i=0; i<3; ++i)
//            {
//                MarketOrderIndicator moi(ios, m_isin_id, 10, pt::seconds(5));
...
//            if (order_dir == OrderDir::Bid)
//            {
//                orel = double(orderbook2.bids(15))/orderbook2.asks(15);
//            }
//            else
//            {
//                orel = double(orderbook2.asks(15))/orderbook2.bids(15);
//            }
...
//                              orderbook3.best_bid() - 2*step :
//                              orderbook3.best_ask() + 2*step,
//                          1);
//            order_id = async2::async_add_order(ios, ctx, order, yield);
//            async2::WaitDeal wait_deal_1(ios, ctx, order_id);
//            __orders = wait_deal_1.async_wait(true, pt::seconds(1), yield[errc]);
//            if (errc)
//            {
//                spawner.spawn(SimpleClosing3(m_isin_id));
...
//                wait_deal_2.async_wait(true, pt::seconds(10), yield[errc]);
//                spawner.reset();
//                t2 = async2::current_datetime(ios);
//            });
