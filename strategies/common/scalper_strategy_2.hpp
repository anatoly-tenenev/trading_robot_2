...
//class ScalperStrategy2 : public atrade::async2::IStrategy
//{
//public:
//    typedef std::shared_ptr<atrade::async2::BooleanIndicator> IndicatorPtr;

//    ScalperStrategy2(boost::asio::io_service* ios, atrade::async2::TradingContext* ctx, int64_t isin_id) :
//        m_ios(ios),
//        m_ctx(ctx),
//        m_isin_id(isin_id),
//        m_profit_trades(0),
...
//    ScalperStrategy2(boost::asio::io_service& ios, atrade::async2::TradingContext& ctx, int64_t isin_id) :
//        ScalperStrategy2(&ios, &ctx, isin_id)
//    {
//    }

//    ScalperStrategy2(int64_t isin_id) :
//        ScalperStrategy2(nullptr, nullptr, isin_id)
//    {
//    }
...
//            for (int i=0; i<3; ++i)
//            {
//                MarketOrderIndicator moi(ios, m_isin_id, 300, pt::seconds(5));
...
//            __orders = wait_deal_1.async_wait(true, pt::seconds(3), yield[errc]);
//            if (errc)
//            {
...
//                auto res = wait_deal_2.async_wait(true, pt::seconds(15), yield[errc]);
//                spawner.reset();
//                t2 = async2::current_datetime(ios);
//                if (!res.empty())
//                {
